...
export const questions = [
  // --- SECTION 1: 压力测试与防御机制 (考察 Intensity & Power) ---
  {
    id: 1,
  ...
  // --- SECTION 2: 关系纽带与生物学性征 (考察 Power & Narrative) ---
  {
    id: 3,
  ...
  // --- SECTION 3: 价值观冲突与理想倾向 (考察 Narrative & Outcome) ---
  {
    id: 5,
  ...
  // --- SECTION 4: 互动质感与排他性 (考察 Power & Intensity) ---
  {
    id: 7,
...
// results 数组和 calculateDiagnosis 函数保持上一版不变即可。
// 它们已经完美适配这套向量逻辑。
export const results = [
  // --- 第一象限：沉重/宏大/对等 ---
  {
    id: "HESG",
    name: "【殉道者的无声墓志铭】",
    desc: "你是极致悲剧美学的追随者。你爱的不是简单的儿女情长，而是两个纯粹的灵魂在理想与立场的撕裂下的终极遗憾。死别亦是永恒的告白。",
    example: "典型病例：ggad、五夏、团兵",
  ...
  },
  {
    ...
    example: "典型病例：SC (萨菲罗斯×克劳德)、鸣佐",
    prognosis: "精神高度亢奋，伴随持续性心律不齐。"
  },
  // --- 第二象限：沉重/宏大/非对称 ---
  {
    id: "HAVG",
    name: "【深渊里的灵魂共生受体】",
    desc: "你偏爱那种带有血腥味和破碎感的依附。在泥泞中互相拖拽、互为药石。这是一种非对称的、生理性的依赖，扒开伤口血肉模糊，却是活下去的唯一理由。",
    example: "典型病例：团孟、军烨",
    prognosis: "重度成瘾性，建议不要试图剥离这种关系。"
  },
  {
    id: "HASG",
    name: "【碎玻璃里的蜜糖锚点】",
    desc: "跨越时间的守望。你是你，而他是你的理智、你的骨骼、你在这荒诞人间唯一的归航信号。虽位势不对等，但稳如磐石，坚不可摧。",
    example: "典型病例：瓶邪、盾冬、地久汪史",
    prognosis: "慢性阵痛，但拥有极强的生存意志。"
  },
  // --- 第三象限：轻盈/宏大/对等 ---
  {
    id: "LESG",
    name: "【成年人的高阶底牌博弈】",
    desc: "极致的清醒与体面。表面上明码标价地算计，但底牌永远只留给对方。这是一种建立在智力对等基础上的浪漫：我们可以不谈爱，但命可以给你。",
    example: "典型病例：黑花、aeon",
    prognosis: "生理机能正常，心智极其坚定。"
  },
  {
    id: "LEVG",
    name: "【光影双生的莫比乌斯环】",
    desc: "镜像的两面，即便打断彼此的手臂也要斩断羁绊，却发现灵魂早已死死咬合。这种关系在博弈中不断波动，在推开与拉近中反复横跳。",
    example: "典型病例：佐鸣、锤基",
    prognosis: "生命力顽强，成长空间巨大。"
  },
  // --- 第四象限：轻盈/日常/对等 ---
  {
    id: "LESD",
    ...
    prognosis: "建议保持适度吐槽，预防多巴胺过载。"
  },
  {
    id: "LEVD",
    name: "【夏日午后的苏打水气泡】",
    desc: "轻盈、酸甜，且充满了未知。你爱的是那种初见时的悸动与相处中的不确定感。哪怕最后由于现实而分开，此刻的火花也足够灿烂。",
    example: "典型病例：各种校园小甜饼、初恋向",
    prognosis: "短期情绪波动，长期回忆温暖。"
  },
  // --- 第五象限：沉重/日常/非对称 ---
  {
    id: "HASD",
  ...
  },
  {
    ...
    prognosis: "建议介入临床心理干预。"
  },
  // --- 第六象限：沉重/日常/对等 ---
  {
    id: "HESD",
    name: "【柴米油盐里的精神互剖】",
    desc: "在极其平凡的日常里，进行着极其深刻的精神解剖。看透了对方最自私的一面，却依然选择在平淡中互相磨损。这是一种冷静的残忍。",
    example: "典型病例：弗吉尼亚·伍尔夫 × 伦纳德",
    prognosis: "警惕抑郁倾向，建议增加户外活动。"
  },
  {
    id: "HEVD",
    name: "【毁灭前夜的享乐主义】",
    desc: "为了此刻的火花，不惜点燃整个明天。关系极其不稳定，充满了爆发性的争吵与激情的复合。你们是彼此的兴奋剂，透支生命换取爱意。",
    example: "典型病例：极具张力的都市现实向CP",
    prognosis: "备好急救药物，预防精神衰竭。"
  },
  // --- 第七象限：轻盈/日常/非对称 ---
  {
    id: "LASD",
    name: "【互补型的精神避风港】",
    desc: "你是重症科里的‘轻症奇迹’。一个是天才/疯子，另一个是他的理智与土壤。不需要宏大叙事，长久稳定的陪伴就是最好的生理救赎。",
    example: "典型病例：陆花、福华",
    prognosis: "心态平稳，生活满意度较高。"
  },
  {
    id: "LAVD",
    name: "【市井烟火里的长久拉扯】",
  ...
  // --- 第八象限：轻盈/宏大/非对称 ---
  {
    ...
    prognosis: "适应性强，能在恶劣环境下生存。"
  },
  {
    id: "LAVG",
    name: "【镜像双生的剥离与重组】",
    desc: "看着两棵树的生长。你们走上截然不同的道路，看透了对方的怯懦，却最终在终点处殊途同归。这是一种极具生命力的共同进化。",
    example: "典型病例：许三多×成才",
    prognosis: "生命力顽强，成长空间巨大。"
  }
];

export const calculateDiagnosis = (scores) => {
  ...
  return results.find(r => r.id === resultCode) || results[results.length - 1];
};